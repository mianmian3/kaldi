...
data=/data/aishell/data_download
...
#  steps/make_mfcc_pitch.sh --cmd "$train_cmd" --nj $para data/$x exp/make_mfcc/$x $mfccdir || exit 1;
...
#steps/decode.sh --cmd "$decode_cmd" --nj $para --config conf/decode.config \
...
# chain
#local/chain/run_tdnn.sh --stage 11 --train_stage 3
#local/chain/run_tdnn.sh --stage 14 --train_stage 20
